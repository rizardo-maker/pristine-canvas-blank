  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed top-4 left-4 z-50 lg:hidden bg-white rounded-md p-2 shadow-soft"
      >
      ...
      <aside 
        className={cn(
          "fixed top-0 left-0 h-full bg-white shadow-card w-64 z-50 transition-transform duration-300 ease-in-out transform",
