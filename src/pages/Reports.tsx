...
import { Download, FileText, Users, DollarSign, TrendingUp, Percent, AlertCircle, CreditCard, Target } from 'lucide-react';
...
const Reports = () => {
  ...
  const financialMetrics = React.useMemo(() => {
    ...
    const totalPrincipleAmount = customers.reduce((sum, customer) => sum + customer.totalAmountGiven, 0);
    const totalPaidAmount = customers.reduce((sum, customer) => sum + customer.totalPaid, 0);
    
    // Calculate received principle and interest based on payment proportions
    const receivedPrinciple = customers.reduce((sum, customer) => {
    ...
    <div className="space-y-6 animate-fade-up">
      ...
      <Card className="shadow-card border-none">
        <CardHeader>
          ...
          <CardDescription>Detailed breakdown of principle and interest amounts</CardDescription>
        </CardHeader>
        <CardContent>
